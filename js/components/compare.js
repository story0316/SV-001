...
function renderBenefitsComparePage() {
  ...
  return `
    <div class="compare-page page-enter">
      ...
      <div class="compare-company-btns" id="compareBtns">
        ${companyBtns}
      </div>
...
function renderCompareTable() {
  ...
  const cols = _compareSelected.length;
  ...
  // Show first 3 categories, 5 items each
          ...
          return `
            <div class="compare-row-cell">
              ${has
                ...
                : `<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#E8EDF2" stroke-width="2.5"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>`
              }
            </div>
          `;
        }).join('')}
