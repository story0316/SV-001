  ...
  return `
    <div class="levels-page page-enter">
      <div class="card">
        ...
        <select class="form-input form-select" style="margin-bottom:16px"
        ...
        <div class="level-grid" id="levelGrid">${levelsHtml}</div>
...
function updateLevelsCompany(company) {
  ...
  document.querySelectorAll('.company-tabs .company-tab').forEach(btn => {
