...
function renderApp() {
  ...
  switch (_currentPage) {
    ...
    case 'company': pageHtml = renderCompanyPage(company); break;
    case 'submit':  pageHtml = renderSubmitPage();         break;
    case 'levels':  pageHtml = renderLevelMappingPage();   break;
    case 'report':  pageHtml = renderSalaryReportPage();   break;
    case 'compare': pageHtml = renderBenefitsComparePage(); break;
